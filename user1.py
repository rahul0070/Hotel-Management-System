...
class User(Tk):
    ...
    def start(self):
        self.title("Online Hotel Booking")
        self.login()
        self.mainloop()
    ...
    def userHome(self,user):
        ...
        B1.pack()
        B2=Button(self,text="Book Tables",command=lambda: self.viewMovies(user))
        B2.pack()
    ...
    def viewShows(self,user,movielist,opt):
        ...
        B1.pack()
        L1=Label(self,text='Menu name : '+movielist[opt][1])
        L1.pack()
        L2=Label(self,text='Cuisine By '+movielist[opt][2])
        L2.pack()
        L3=Label(self,text='Prep time : '+str(movielist[opt][3]))
        L3.pack
    ...
    def bookShow(self,user,showlist,opt,moviename):
        self.clear()
        L1=Label(self, text='Menu : '+moviename)
        ...
        L4=Label(self,text='Select Tables : ')
